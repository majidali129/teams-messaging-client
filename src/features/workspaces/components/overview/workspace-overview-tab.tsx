...
import { CalendarIcon, MessagesSquareIcon, ShieldCheckIcon, UsersIcon } from "lucide-react";
          ...
          <Card key={stat.label}>
            <CardContent className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className={`truncate text-sm font-semibold ${stat.capitalize ? "capitalize" : ""}`}>
                  {stat.value}
                </p>
              </div>
            </CardContent>
      ...
      <Card>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium">{owner?.name ?? "Unknown owner"}</p>
              <p className="text-xs text-muted-foreground">Workspace owner · {owner?.email}</p>
            </div>
          </div>
